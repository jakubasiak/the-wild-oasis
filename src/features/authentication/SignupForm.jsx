  ...
  return (
    <Form onSubmit={handleSubmit(onSubmit)}>
      ...
      <FormRow label="Email address" error={errors?.email?.message}>
        <Input type="email" id="email" autoComplete="false" {...register('email', {
          required: 'This field is required',
      ...
      <FormRow label="Password (min 8 characters)" error={errors?.password?.message}>
        <Input type="password" id="password" autoComplete="false" {...register('password', {
          required: 'This field is required',
          minLength: { value: 8, message: 'Password needs a minimum 8 characters' }
        })} />
      </FormRow>
